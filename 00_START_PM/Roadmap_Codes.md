...
|---|---|---|---|---|---|---|---|
| A 紀錄工具站穩 | 1 | EP07、EP03+EP12、EP09 | M03-F04 植栽資料匯出(擴充)、M01-F03 廠商群組管理、M07-F01 稽核紀錄、M03-F03 植栽批次匯入、巡察(屬 M04,無獨立 F)、自訂欄位(M04 三載體) | G07 稽核無表、G10 匯入不可追溯、G03 巡察無表、G01 維養無表 | E8(已回:落點確認) | DEC-004;候 DEC-014 | M03-F04 補規格 P3(擴充);M01-F03 新建 P1;M07-F01 新建 P1;M03-F03 補規格 P3(加批次表=歸位);巡察新建 |
...
| D 樹木管理建議 | 2 | 需新 Epic(候 EP16);EP09 | M04-F03 健康調查與病蟲害 | G02 健康資料無表 | 無 | 候 DEC-015 範圍變更 | M04-F03 新建 P2;建議規則無 F(現行範圍外) |
